...
require 'time'
require 'lib/feedparser/textconverters'
require 'lib/feedparser/rexml_patch'
require 'lib/feedparser/text-output'
require 'base64'
  ...
  class AtomItem < FeedItem
    def parse(item)
      ...
      item.each_element('link') do |e|
        ...
        break if (alt = e.attribute('rel')) && alt.value == 'alternate'
      end
      # Content
